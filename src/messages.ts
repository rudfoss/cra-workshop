export const messages = [
	...
	"Mauris tristique libero eu ex sagittis, ac bibendum ipsum pellentesque.",
	"Nunc et felis ac libero eleifend varius."
]
...
export const messageObj = {
	...
	"volutpat": "Donec molestie leo nec nibh volutpat, eget consequat nunc elementum.",
	"lorem": "Phasellus euismod lorem vel leo semper, sed vehicula augue vehicula.",
